...
public class CrashHandler implements UncaughtExceptionHandler {
    ...
    public void uncaughtException(Thread thread, Throwable ex) {
        try {
            //导出异常信息到SD卡中
            Uri uri = dumpExceptionToSDCard(ex);
            if (uri != null)
                PreferencesUtils.setString(mContext, mContext.getString(R.string.crash_uri), uri.toString());
    ...
    private Uri dumpExceptionToSDCard(Throwable ex) throws IOException {
